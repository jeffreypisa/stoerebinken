...
export function menugrid() {
    ...
    // Check if 'mod-projecten-uitgelicht' exists on the page
    if (!document.querySelector('.mod-projecten-uitgelicht')) {
        // If not, exit the function
        return;
    }
    
    // preview Items
    const previewItems = [...document.querySelectorAll('.js-menugrid .preview > .preview__item')];
    // initial rows
    const rows = [...document.querySelectorAll('.js-menugrid .row')];
    // cover element
    const cover = document.querySelector('.js-menugrid .cover');
    // close ctrl
    const closeCtrl = document.querySelector('.js-menugrid .preview > .preview__close');
