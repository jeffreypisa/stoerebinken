<?php 
	...
	register_post_type('prijstabel', array(
		'labels' => array(
			'name'                  => __( 'Prijstabellen' ),
			'singular_name'         => __( 'Prijstabel' ),
			'all_items'             => __( 'Alle prijstabellen' ),
			'add_new'               => __( 'Nieuwe prijstabel' ),
			'add_new_item'          => __( 'Nieuwe prijstabel toevoegen' ),
			'edit_item'             => __( 'Bewerk prijstabel' ),
			'new_item'              => __( 'Nieuwe prijstabel' ),
			'view_item'             => __( 'Bekijk prijstabel' ),
			'search_items'          => __( 'Zoek prijstabel' ),
			'not_found'             => __( 'Geen prijstabellen gevonden' ),
			'not_found_in_trash'    => __( 'Geen prijstabellen gevonden in prullenbak' ),
		),
		'menu_icon'            => 'dashicons-chart-bar',
	
		// Belangrijk: alleen in admin, niet publiek
		'public'               => false,
		'show_ui'              => true,
		'show_in_menu'         => true,
		...
		// Geen front-end routes of queries
